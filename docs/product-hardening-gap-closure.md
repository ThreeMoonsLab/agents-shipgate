...
| Adoption benchmark was not a governance benchmark | [`../benchmark/agent-pr-governance/`](../benchmark/agent-pr-governance/) defines the AgentPR Governance case catalog and acceptance metrics | `tests/test_product_hardening_gap_closure.py` validates the catalog shape and category coverage |
...
- New benchmark, trace, and runtime-inventory artifacts do not introduce a schema bump or a second verdict.
