...
[report-schema.v0.25.json](report-schema.v0.25.json) (current; emitted reports
carry `report_schema_version: "0.25"`, adding opt-in capability-linked local trace/provenance evidence;
