...
carry `report_schema_version: "0.31"` and add the Conductor OSS framework
summary over the frozen provider-scoped identity contract in
[report-schema.v0.30.json](report-schema.v0.30.json)).
