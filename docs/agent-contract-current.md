...
- Current packet schema: `0.13` — [`docs/packet-schema.v0.13.json`](packet-schema.v0.13.json) (v0.12 and earlier stay frozen; `0.13` adds `declaration_below_inferred_evidence` to the evidence-gap union)
- Current shared agent result schema: `agent_result_v3` — [`docs/agent-result-schema.v3.json`](agent-result-schema.v3.json)
- Current verifier schema: `0.10` — [`docs/verifier-schema.v0.10.json`](verifier-schema.v0.10.json) (v0.9 and earlier stay frozen; `0.10` adds `declaration_below_inferred_evidence` to the evidence-gap union)
