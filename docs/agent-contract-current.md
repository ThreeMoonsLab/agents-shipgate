...
- Current host-grants inventory, baseline, and drift schemas: `0.5` — [`inventory`](host-grants-inventory-schema.v0.5.json), [`baseline`](host-grants-baseline-schema.v0.5.json), [`drift`](host-grants-drift-schema.v0.5.json)
