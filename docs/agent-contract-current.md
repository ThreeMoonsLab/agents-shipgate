...
`must_stop == (state == "human_review_required")`. Report v0.36, packet v0.13,
...
- Current packet schema: `0.13` — [`docs/packet-schema.v0.13.json`](packet-schema.v0.13.json)
- Current shared agent result schema: `agent_result_v3` — [`docs/agent-result-schema.v3.json`](agent-result-schema.v3.json)
- Current verifier schema: `0.9` — [`docs/verifier-schema.v0.10.json`](verifier-schema.v0.10.json) (v0.8 and earlier stay frozen; `0.9` adds `capability_review.policy_weakening_proven`)
...
schema [`docs/verifier-schema.v0.10.json`](verifier-schema.v0.10.json)). **Lead
...
[`docs/packet-schema.v0.13.json`](packet-schema.v0.13.json) — see
...
- [`docs/packet-schema.v0.13.json`](packet-schema.v0.13.json) — machine-validatable JSON Schema for the current packet.
