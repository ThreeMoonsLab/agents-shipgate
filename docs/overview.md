...
- [Report schema v0.42](report-schema.v0.42.json) (current; v0.41 frozen at [report-schema.v0.41.json](report-schema.v0.41.json), with older references in the [index](INDEX.md#reference))
