...
- [Report schema v0.36](report-schema.v0.36.json) (current; v0.35 frozen at [report-schema.v0.35.json](report-schema.v0.35.json), with older references in the [index](INDEX.md#reference))
