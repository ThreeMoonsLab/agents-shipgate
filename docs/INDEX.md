...
- [`host-grants-inventory-schema.v0.5.json`](host-grants-inventory-schema.v0.5.json) — current typed, redacted, scope-aware host inventory; records the in-tree links a read followed
...
- [`host-grants-baseline-schema.v0.5.json`](host-grants-baseline-schema.v0.5.json) — current acknowledged host-grant baseline
- [`host-grants-baseline-schema.v0.4.json`](host-grants-baseline-schema.v0.4.json) — frozen v0.4 reference; still compared by drift
...
- [`host-grants-drift-schema.v0.5.json`](host-grants-drift-schema.v0.5.json) — current comparable/incomparable host-grant drift result
