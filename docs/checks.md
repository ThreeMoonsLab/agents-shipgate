...
Removing a setting raises nothing of its own, as removing `defaultMode` never
did. A host-boundary policy may raise this rule, and then raises these
ratings with it; it cannot lower them.
