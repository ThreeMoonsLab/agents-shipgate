...
| `host_discovery_incomplete_paths` is non-empty | Unfollowed host traversal | Inspect the named links or select the actual project directory. Empty candidates do not prove absence. |
