...
The packet schema is `0.18`; full schema at [`docs/packet-schema.v0.18.json`](packet-schema.v0.18.json). It projects current report binding and semantic coverage, base-vs-head declaration review, and gap remediation; v0.17 and older versions are frozen references.
...
| CLI contract | `34` | — | `agents-shipgate contract --json` |
