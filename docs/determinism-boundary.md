...
This page describes **agents-shipgate 1.0.0**, and its rows move as the adapters do — `schema_version` (`shipgate.determinism_boundary/v1`) versions the shape of the machine-readable companion, not the routes.
