...
`next_action.path` is nonblank after normalization (format characters removed,
whitespace/control runs collapsed), falling back to the first row when
