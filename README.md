...
- **[`docs/capability-lock-schema.v0.8.json`](docs/capability-lock-schema.v0.8.json)** + **[`docs/capability-lock-diff-schema.v0.9.json`](docs/capability-lock-diff-schema.v0.9.json)** — current capability standard v0.5 schemas, including binding hashes, for the static capability envelope and semantic diff; non-gating and separate from `report.json`.
