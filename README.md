...
- The manifest remains `version: "0.1"` so existing configs keep working. Current reports carry `report_schema_version: "0.39"`; every narrowing decision is recorded in `surface_exclusions` and reachable by the release decision, while v0.38 remains frozen for archived reports.
...
- [JSON report schema v0.39](docs/report-schema.v0.39.json)
- [JSON report schema v0.38 (frozen)](docs/report-schema.v0.38.json)
...
- [Capability lock schema v0.7](docs/capability-lock-schema.v0.7.json)
- [Capability lock diff schema v0.8](docs/capability-lock-diff-schema.v0.8.json)
