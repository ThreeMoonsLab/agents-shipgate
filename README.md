...
- The manifest remains `version: "0.1"` so existing configs keep working. Current reports carry `report_schema_version: "0.41"`; every narrowing decision is recorded in `surface_exclusions` and reachable by the release decision, while v0.40 remains frozen for archived reports.
...
- [JSON report schema v0.41](docs/report-schema.v0.41.json)
