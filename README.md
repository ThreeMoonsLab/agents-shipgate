...
`verify` also writes `agent-result.json` for compact Action/automation
consumers; treat that artifact and the Action `agent_decision` output as
supporting/provisional projections, not the CI gate.
