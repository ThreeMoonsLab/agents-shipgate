...
- The manifest remains `version: "0.1"` so existing configs keep working. Current reports carry `report_schema_version: "0.36"`; a declaration weaker than observed effect evidence is recorded rather than accepted in silence, while v0.35 remains frozen for archived reports.
