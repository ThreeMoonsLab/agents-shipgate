...
verdict as a PR comment. This is the comment for the bundled demo PR — a
coding-agent diff that adds `stripe.create_refund` to a support agent
...
Reproduce it locally in one command, no install, no setup:
