...
Reason: Insufficient evidence: the agent's tool binding graph is incomplete \(agent\_v1:7205d836e4b3fee257d90695\). Fix at shipgate.yaml\#agent\_bindings. Context: 1 semantic evidence gap\(s\) and 1 low-confidence tool\(s\) and 4 source warning\(s\); scan results are not trustworthy enough to gate release.
