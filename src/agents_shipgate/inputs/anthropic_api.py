...
class AnthropicAPIAdapter:
    ...
    coverage: ClassVar[SourceCoverage] = SourceCoverage(
        ...
        label="Anthropic Messages API artifacts",
        reads=(
        ...
        cells=(
            BoundaryCell(
                ...
                status="extracted",
                reads=(
                    "A committed tool definition with its `input_schema`, read as "
                    "the published contract it is. A client tool declared by `type` "
                    "carries that typed provider fact with it."
                ),
                emits=("anthropic_api",),
                ceiling="high",
            ),
            BoundaryCell(
                ...
                reads=(
                    ...
                    "are read by the framework inputs."
                ),
            ),
            BoundaryCell(
                shape="factory",
            ...
            BoundaryCell(
                ...
                status="not_applicable",
                reads=(
                    "A tool definition names its `input_schema` or it is not a tool "
                    "definition."
                ),
            ),
        ),
