    ...
    *,
    ...
    report = build_report(
        run_id=_run_id(
            ...
            tool_catalog=sanitized.tool_catalog,
            binding_graph=sanitized.binding_graph,
        ),
        ...
        tool_catalog=sanitized.tool_catalog,
        binding_surface_facts=sanitized.binding_graph,
        binding_surface_diff=sanitized.binding_surface_diff,
