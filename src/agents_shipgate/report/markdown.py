...
DISCLAIMER = (
    ...
    "for AI agent tool surfaces. It does not certify agent safety or compliance. "
    "Findings are based on static configuration, declared policies, tool schemas, "
    "and optional SDK metadata. Runtime behavior, actual tool routing, and output "
    "interpretation are not verified."
)
