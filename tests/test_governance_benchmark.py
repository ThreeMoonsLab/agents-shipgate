...
def test_governance_benchmark_preserves_public_schema_boundaries() -> None:
    assert ReadinessReport.model_fields["report_schema_version"].default == "0.36"
    assert CAPABILITY_LOCK_SCHEMA_VERSION == "0.7"
    assert CAPABILITY_LOCK_DIFF_SCHEMA_VERSION == "0.8"
