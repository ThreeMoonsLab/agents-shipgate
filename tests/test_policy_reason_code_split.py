...
def test_the_frozen_v0_8_schema_still_describes_v0_8_artifacts():
    ...
    current = json.loads(
        (REPO_ROOT / "docs" / "verifier-schema.v0.16.json").read_text("utf-8")
    )
    ...
    assert current["properties"]["verifier_schema_version"]["const"] == "0.16"

    from agents_shipgate.schemas.verifier import VerifierArtifact

    assert VerifierArtifact.model_fields["verifier_schema_version"].default == "0.16"
