...
- **All three pinned walk candidates read `tools_scanned=0`.** Both
  ...
  walks knew best — one of them the server whose walk drove
  `tool_sources[].binding` in the first place.
